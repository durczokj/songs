...
public record SyncResult(SyncPlan plan, List<AddResult> added, List<RemoveResult> removed) {
  ...
  private static void appendFailures(
      StringBuilder sb, int count, java.util.function.IntFunction<String> line) {
