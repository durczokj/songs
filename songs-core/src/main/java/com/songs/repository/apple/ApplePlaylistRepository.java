...
/**
 * Read-only {@link PlaylistReader} for Apple Music playlists using the catalog API (see {@link
 * AppleMusicTokenProvider}, {@link ApplePlaylistPaginator}).
 */
public class ApplePlaylistRepository implements PlaylistReader {
  ...
  public ApplePlaylistRepository(
      AppleMusicTokenProvider tokenProvider, ApplePlaylistPaginator paginator) {
  ...
  public Playlist extract(String uri) throws IOException {
    ...
    logger.info(
        "Extracted {} tracks from Apple Music playlist {}",
